...
 
Admin:
- Under admin menu use “Newsletter Subscribers” to list all the subscribers
- unsubscribe a subscription by clicking “unsubscribe” link from the list
- use the search option to search for any subscription using email or first_name
